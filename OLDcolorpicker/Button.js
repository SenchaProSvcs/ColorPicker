/**
 * @class Ext.uxold.colorpicker.Button
 * @extends Ext.Component
 *
 */
Ext.define('Ext.uxold.colorpicker.Button', {
    extend : 'Ext.Component',
    alias  : 'widget.oldcolorpickerbutton',
    ...
    colorChanged : function(rgb, alpha, intermediate) {
        ...
        var rgba = Ext.uxold.colorpicker.color.getRGBAString(me.color);
    ...
    updatePreviewColors : function() {
        //this.alphaColorEl.dom.style.backgroundColor = Ext.uxold.colorpicker.color.getRGBAString(this.color);
    },
