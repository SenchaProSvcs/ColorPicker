/**
 * @class Ext.uxold.colorpicker.Colorpicker
 * @extends Ext.uxold.colorpicker.Popup
 *
 */
...
Ext.define('Ext.uxold.colorpicker.Colorpicker', {
    extend : 'Ext.uxold.colorpicker.Popup',

    requires : [
        'Ext.uxold.colorpicker.View',
    ...
    statics : {
        ...
        /**
         *
         * @return Ext.uxold.colorpicker.Colorpicker
         */
        getSharedColorpickerInstance : function() {
            if (!this._sharedColorpicker) {
                this._sharedColorpicker = new Ext.uxold.colorpicker.Colorpicker();
            }
    ...
    onRender : function() {
        ...
        me.view = new Ext.uxold.colorpicker.View();
    ...
    onFieldChange : function(value, colorChannel) {
        ...
        switch (colorChannel) {
            ...
            case 'a':
                ...
                break;
            case 'hex':
                me.rgb = Ext.uxold.colorpicker.color.hex2rgb(value, this.rgb);
                me.updateHSV();
                break;
        }
    ...
    setRGBA : function(r, g, b, a) {
        ...
        me.rgb   = [r, g, b];
        me.alpha = a;
        me.hsv   = Ext.uxold.colorpicker.color.rgb2hsv(r, g, b);
    ...
    updateRGB : function() {
        var hsv = this.hsv;
        this.rgb = Ext.uxold.colorpicker.color.hsv2rgb(hsv[0], hsv[1], hsv[2]);
    },
    ...
    updateHSV : function() {
        var rgb = this.rgb;
        this.hsv = Ext.uxold.colorpicker.color.rgb2hsv(rgb[0], rgb[1], rgb[2]);
    },
