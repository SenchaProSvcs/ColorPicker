/**
 * @class Ext.uxold.colorpicker.View
 *
 */
Ext.define('Ext.uxold.colorpicker.View', {
    requires : [
        'Ext.uxold.colorpicker.AlphaSlider',
        'Ext.uxold.colorpicker.color',
        'Ext.uxold.colorpicker.Drag',
        'Ext.uxold.colorpicker.HueSlider',
        'Ext.uxold.colorpicker.Map',
        'Ext.uxold.colorpicker.SaturationSlider',
        'Ext.uxold.colorpicker.Swatches',
        'Ext.uxold.colorpicker.ValueSlider',
        'Ext.form.field.Text'
    ],
    ...
    renderInsideElement : function(parent) {
        ...
        me.barS = new Ext.uxold.colorpicker.SaturationSlider();
        ...
        me.barV = new Ext.uxold.colorpicker.ValueSlider();
        ...
        me.barA = new Ext.uxold.colorpicker.AlphaSlider();
        ...
        me.swatches = new Ext.uxold.colorpicker.Swatches();
        ...
        me.newColorHandler = new Ext.uxold.colorpicker.Drag({
        ...
        me.oldColorHandler = new Ext.uxold.colorpicker.Drag({
    ...
    setColor : function(rgb, alpha, hsv) {
        ...
        me.setField(me.hexField,        "#" + Ext.uxold.colorpicker.color.rgb2hex(rgb));
    },
