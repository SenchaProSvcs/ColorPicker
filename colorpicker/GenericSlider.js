/**
 * @class Ext.ux.colorpicker.GenericSlider
 *
 */
Ext.define('Ext.ux.colorpicker.GenericSlider', {
    requires : [
    ...
    renderInsideElement : function(parent, width, height) {
        ...
        Ext.apply(me, {
            ...
            dragtracker  : Ext.create('Ext.ux.colorpicker.Drag', {
                element       : parent,
    ...
    onSliderMoveStart : function(dragtracker, event) {
        ...
        if (!startOnPicker) {
            xy = Ext.ux.colorpicker.util.getLocalCoords(me.parent, event.xy);
    ...
    RGBAcolorAt : function(y) {
        var rgb = Ext.ux.colorpicker.color.hsv2rgb(y, this.s, this.v);
        rgb.push(255); //rgba
