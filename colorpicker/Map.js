/**
 * @class Ext.ux.colorpicker.Map
 * @extends Ext.ux.colorpicker.GenericSlider
 *
 */
Ext.define('Ext.ux.colorpicker.Map', {
    extend : 'Ext.ux.colorpicker.GenericSlider',

    requires : [
        'Ext.ux.colorpicker.util'
    ],
    ...
    renderColor : function() {
        var rgb = Ext.ux.colorpicker.color.hsv2rgb(this.h, 1, 1);
    ...
    onSliderMoveStart : function(dragtracker, event) {
        ...
        if (!startOnPicker) {
            ...
            //get local position
            var xy = Ext.ux.colorpicker.util.getLocalCoords(this.parent, event.xy);
