Ext.define('Ext.ux.colorpicker.ColorMapController', {
    ...
    onColorBindingChanged: function(selectedColor) {
        ...
        hsv = Ext.ux.colorpicker.ColorUtils.rgb2hsv(rgba.r, rgba.g, rgba.b);
    ...
    onHueBindingChanged: function(hue) {
        ...
        fullColorRGB = Ext.ux.colorpicker.ColorUtils.hsv2rgb(hue, 1, 1);
        hex = Ext.ux.colorpicker.ColorUtils.rgb2hex(fullColorRGB.r, fullColorRGB.g, fullColorRGB.b);
